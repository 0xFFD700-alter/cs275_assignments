...
bool tinygltf_parsefile(const std::string& filename, tinygltf::Model& gltf) {
   ...
   //std::string  filename_modified = "C:/Users/PC/Desktop/cs275/assignment1-skeletal-XiaoyuXiao1998/reference" + filename;
    ...
    if (!result) {
        std::cout << "Failed to load gltf file: " << filename.c_str() << std::endl;
    }
